...
- Cleanup and standardization of LUX Api calls ([PR 549](https://github.com/input-output-hk/daedalus/pull/549))
- Unused vendor dependencies cleanup and DLL file optimization ([PR 555](https://github.com/input-output-hk/daedalus/pull/555))
- Introduce `testReset` endpoint for LUX api ([PR 558](https://github.com/input-output-hk/daedalus/pull/558))
