...
- Do not block the UI while wallet is being restored/imported ([PR 457](https://github.com/216k155/luxcore/pull/457))

### Fixes

- Improved messages for update notifications ([PR 526](https://github.com/216k155/luxcore/pull/526))
...
- Postpone Update Api call integration ([PR 485](https://github.com/216k155/luxcore/pull/485))
- Wallet restore recovery phrase textarea replaced with React-Polymorph Autocomplete ([PR 516](https://github.com/216k155/luxcore/pull/516))

### Fixes

- Fix error message text for A to A transaction error ([PR 484](https://github.com/216k155/luxcore/pull/484))
- Fix "label prop type" checkbox issue in react-polymorph ([PR 487](https://github.com/216k155/luxcore/pull/487))
- Remove all drag and drop instructions from UI ([PR 495](https://github.com/216k155/luxcore/pull/495))
- Preferences saved to local storage prefixed with network ([PR 501](https://github.com/216k155/luxcore/pull/501))
- Disable wallet import and export features for the mainnet ([PR 503](https://github.com/216k155/luxcore/pull/503))
- Correctly prevent max-window-size in electron ([PR 532](https://github.com/216k155/luxcore/pull/532))
- Make sure wallet import and restore in-progress notification is hidden once process is done ([PR 540](https://github.com/216k155/luxcore/pull/540))
- Fix broken translation files loading ([PR 559](https://github.com/216k155/luxcore/pull/559))
- Fix async wallet import/restore issues ([PR 562](https://github.com/216k155/luxcore/pull/562))

### Chores

- Update version in About dialog to 0.8.2 ([PR 496](https://github.com/216k155/luxcore/pull/496))
- Set Dark theme as default one for the mainnet ([PR 497](https://github.com/216k155/luxcore/pull/497))
- JS-Api integration ([PR 525](https://github.com/216k155/luxcore/pull/525))
- Only log errors to papertrail ([PR 509](https://github.com/216k155/luxcore/pull/509))
- Update MobX React Form to latest version ([PR 533](https://github.com/216k155/luxcore/pull/533))
- Update Electron, electron-devtools-installer, electron-packager and electron-rebuild to latest versions ([PR 541](https://github.com/216k155/luxcore/pull/541))
- Update flow-bin to version `0.59.0` ([PR 544](https://github.com/216k155/luxcore/pull/544))
- Cleanup and standardization of LUX Api calls ([PR 549](https://github.com/216k155/luxcore/pull/549))
- Unused vendor dependencies cleanup and DLL file optimization ([PR 555](https://github.com/216k155/luxcore/pull/555))
- Introduce `testReset` endpoint for LUX api ([PR 558](https://github.com/216k155/luxcore/pull/558))
- Update acceptance tests suite dependencies ([PR 561](https://github.com/216k155/luxcore/pull/561))
- Refactor Luxcoin type declarations to type folder ([PR 557](https://github.com/216k155/luxcore/pull/557))

## 0.8.1

### Fixes

- Fix all features eslint warnings ([PR 468](https://github.com/216k155/luxcore/pull/468))
- Fix for disabled buttons on dark-blue theme ([PR 473](https://github.com/216k155/luxcore/pull/473))
- Remove maximum screen width and height in full-screen mode ([PR 472](https://github.com/216k155/luxcore/pull/472))
- Fix "label click" dropdown issue in react-polymorph ([PR 479](https://github.com/216k155/luxcore/pull/479))
...
- Added support for Cmd+H hotkey shortcut for hiding application window on OSX ([PR 404](https://github.com/216k155/luxcore/pull/404))
- Setup environment variable for testnet/mainnet mode ([PR 400](https://github.com/216k155/luxcore/pull/400))
- Export wallet to file ([PR 426](https://github.com/216k155/luxcore/pull/426))
- Add theming options in settings ([PR 370](https://github.com/216k155/luxcore/pull/398))
- About page, available from the system menu ([PR 430](https://github.com/216k155/luxcore/pull/430))
- Setup default themes for TN and MN and introduce new theme names ([PR 451](https://github.com/216k155/luxcore/pull/451))
- Transaction fees UX improvements on wallet sent screen ([PR 449](https://github.com/216k155/luxcore/pull/449))
- Acceptance tests for General Settings screens ([PR 466](https://github.com/216k155/luxcore/pull/466))
- Simple confirmation dialog for sending money ([PR 481](https://github.com/216k155/luxcore/pull/481))
- Japanese terms of use for the mainnet ([PR 486](https://github.com/216k155/luxcore/pull/486))

### Fixes

- Implement MomentJs internationalization
- Also quit whole app when last window is closed on osx
- Luxcore and Luxcoin node update notification text messages change ([PR 392](https://github.com/216k155/luxcore/pull/392))
- Fixed brittle acceptance test steps (wallet latest transaction amount check) ([PR 393](https://github.com/216k155/luxcore/pull/393))
- Fixed Numeric component caret position bug on wallet send screen ([PR 394](https://github.com/216k155/luxcore/pull/394))
- Fixed all design implementation issues ([PR 397](https://github.com/216k155/luxcore/pull/397))
- Fixed eslint syntax warnings ([PR 403](https://github.com/216k155/luxcore/pull/403))
- Fixed wallet spending password fields error messages positioning on wallet create/restore/import dialogs ([PR 407](https://github.com/216k155/luxcore/pull/407))
- Fixed inline-editing success-messages on wallet settings screen ([PR 408](https://github.com/216k155/luxcore/pull/408))
- Fixed dialogs cut-off content on smaller screens ([PR 370](https://github.com/216k155/luxcore/pull/398))
- Fixed the issue of dialogs being closable while wallet import/creation/restoring is happening ([PR 393](https://github.com/216k155/luxcore/pull/414))
- Fixed calculation and display of transaction assurance levels ([PR 390](https://github.com/216k155/luxcore/pull/416))
- Fixes Transaction additional info showing/hiding affects all user's wallets ([PR 411](https://github.com/216k155/luxcore/pull/411))
- Fixed promise handling for unmounted wallet send form [PR 412](https://github.com/216k155/luxcore/pull/412)
- Fixes Transaction toggle issue on active wallet change ([PR 421](https://github.com/216k155/luxcore/pull/421))
- Fixed missing 'used address' styling for default wallet address on wallet receive screen ([PR 422](https://github.com/216k155/luxcore/pull/422))
- Terms of service for the mainnet ([PR 425](https://github.com/216k155/luxcore/pull/425))
- Fixed failing acceptance tests ([PR 424](https://github.com/216k155/luxcore/pull/424))
- Show correct error message on sending money to Ada redemption address ([PR 423](https://github.com/216k155/luxcore/pull/423))
- Fixed ENOENT error on log file rotation ([PR 428](https://github.com/216k155/luxcore/pull/428))
- Fixed logging error ([PR 431](https://github.com/216k155/luxcore/pull/431))
- Add theming support on UI which was introduced after introduction of Theming feature ([PR 434](https://github.com/216k155/luxcore/pull/434))
- Speed-up About page opening time ([PR 450](https://github.com/216k155/luxcore/pull/450))
- Importing a wallet from a file updated-API integration ([PR 439](https://github.com/216k155/luxcore/pull/439))
- Exporting a wallet updated-API integration ([PR 438](https://github.com/216k155/luxcore/pull/438))
- Show correct error message for A -> A transaction error ([PR 441](https://github.com/216k155/luxcore/pull/441))
- Improved QR code colors on wallet send screen for dark themes ([PR 448](https://github.com/216k155/luxcore/pull/448))
- Fixed transaction fees flicker on wallet send screen form submit ([PR 456](https://github.com/216k155/luxcore/pull/456))
- Fixed failing acceptance-tests ([PR 454](https://github.com/216k155/luxcore/pull/454))
- Prevent application window auto focusing while running acceptance-tests ([PR 458](https://github.com/216k155/luxcore/pull/458))
- Limit and validate wallet's name maximum length ([PR 465](https://github.com/216k155/luxcore/pull/465))
- UI/UX fixes ([PR 476](https://github.com/216k155/luxcore/pull/476))

### Chores

- Added readme file for running acceptance tests ([PR 395](https://github.com/216k155/luxcore/pull/395))
- Improved webpack build performance ([PR 402](https://github.com/216k155/luxcore/pull/402))
- Updated README file "Development - network options" section ([PR 410](https://github.com/216k155/luxcore/pull/410))
- All CSS hardcoded values replaced with variables ([PR 370](https://github.com/216k155/luxcore/pull/398))
- Implemented sync progress and payment requests with new JS api as first step to remove the purescript api ([PR 437](https://github.com/216k155/luxcore/pull/437))
- Speed optimizations for page reloads while running tests by loading bundled up for one-time tests runs ([PR 448](https://github.com/216k155/luxcore/pull/445))
- Optimized structure and naming of theming files ([PR 453](https://github.com/216k155/luxcore/pull/453))
- Added testnet label, loaded from translations for release candidate ([PR 460](https://github.com/216k155/luxcore/pull/460))
...
- Replaced all React-Toolbox components with React-Polymorph ones ([PR 361](https://github.com/216k155/luxcore/pull/361))
