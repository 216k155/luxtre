...
Given(/^I have accepted "Lux Redemption Disclaimer"$/, async function () {
  await this.client.execute(() => {
    lux.actions.ada.adaRedemption.acceptRedemptionDisclaimer.trigger();
  });
});
...
Given(/^I see the "Lux Redemption Disclaimer" overlay$/, function () {
...
Then(/^I should not see the "Lux Redemption Disclaimer" overlay anymore$/, function () {
