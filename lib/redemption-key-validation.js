...
export const isValidRedemptionKey = (code) => {
  // Return true if:
  //  * its base64 or base64url decodable - lux vending state mess
  //  * ends with '=' - base64 padds string with optional '=' or two '=' signs. In lux vending phase we were using base64 configured where '=' was always added at the end.
  ...
  //      > base64url.toBuffer("qL8R4QIcQ_ZsRqOAbeRfcZhilN_MksRtDaEAAAArM-A").length
  //          32
  //  Later example above is 32 byte long but its not valid lux redemption key because lux redemption key ends with '=' (lib used in above example is https://www.npmjs.com/package/base64url)
