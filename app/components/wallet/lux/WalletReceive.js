...
import styles from './WalletReceiveLux.scss';

const messages = defineMessages({
  walletAddressLabel: {
    id: 'wallet.receive.page.lux.walletAddressLabel',
    defaultMessage: '!!!Your wallet address',
    description: 'Label for wallet address on the LUX wallet "Receive page"',
  },
  walletReceiveInstructions: {
    id: 'wallet.receive.page.lux.walletReceiveInstructions',
    defaultMessage: '!!!Share this wallet address to receive payments.',
    description: 'Wallet receive payments instructions on the LUX wallet "Receive page"',
  },
});
