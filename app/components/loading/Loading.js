...
import luxLogoWhite from '../../assets/images/lux-logo-loading-white.inline.svg';
import luxLogo from '../../assets/images/lux-logo-loading-grey.inline.svg';
...
export default class Loading extends Component<Props> {
  ...
  render() {
    ...
    const luxLogoStyles = classNames([
      styles.luxLogo,
    ...
    const luxLoadingLogo = isConnecting ? luxLogoWhite : luxLogo;
    ...
    return (
      <div className={componentStyles}>
        ...
        <SvgInline svg={luxLoadingLogo} className={luxLogoStyles} />
